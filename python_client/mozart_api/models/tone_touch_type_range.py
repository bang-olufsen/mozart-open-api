...
class ToneTouchTypeRange(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ToneTouchTypeRange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ToneTouchTypeRange:
        """Create an instance of ToneTouchTypeRange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ToneTouchTypeRange.parse_obj(obj)

        _obj = ToneTouchTypeRange.parse_obj(
            {
                "default": (
