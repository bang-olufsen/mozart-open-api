...
class BassManagementFeature(BaseModel):
    ...
    value: Annotated[StrictStr, Field(description="Selected bass-management value")]
    default: BassManagement
    range: Annotated[List[BassManagement], Field(description="bass-management range")]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": obj.get("value"),
            "default": BassManagement.from_dict(obj["default"])
            if obj.get("default") is not None
            else None,
            "range": [BassManagement.from_dict(_item) for _item in obj["range"]]
