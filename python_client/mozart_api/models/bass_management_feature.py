...
class BassManagementFeature(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BassManagementFeature:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BassManagementFeature:
        """Create an instance of BassManagementFeature from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BassManagementFeature.parse_obj(obj)

        _obj = BassManagementFeature.parse_obj(
            {
                "value": obj.get("value"),
                "default": (
                    BassManagement.from_dict(obj.get("default"))
                    if obj.get("default") is not None
                    else None
                ),
                "range": (
                    [BassManagement.from_dict(_item) for _item in obj.get("range")]
