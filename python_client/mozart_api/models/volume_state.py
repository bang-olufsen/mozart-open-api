...
class VolumeState(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "default": VolumeLevel.from_dict(obj["default"])
            if obj.get("default") is not None
            else None,
            "level": VolumeLevel.from_dict(obj["level"])
            if obj.get("level") is not None
            else None,
            "maximum": VolumeLevel.from_dict(obj["maximum"])
            if obj.get("maximum") is not None
            else None,
            "muted": VolumeMute.from_dict(obj["muted"])
