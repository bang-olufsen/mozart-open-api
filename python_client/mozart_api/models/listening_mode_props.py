...
class ListeningModeProps(BaseModel):
    ...
    client_ctx: Annotated[
        Optional[Annotated[str, Field(strict=True, max_length=4096)]],
        Field(
    ...
    name: Annotated[Optional[StrictStr], Field(description="Friendly name")] = None
    origin: Annotated[
        Optional[StrictStr],
        Field(description="User created, default or an edited default listening mode"),
    ] = None
    role: Annotated[
        Optional[StrictStr], Field(description="Role a listening mode applies to")
    ] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "features": ListeningModeFeatures.from_dict(obj["features"])
