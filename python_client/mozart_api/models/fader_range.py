...
class FaderRange(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FaderRange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FaderRange:
        """Create an instance of FaderRange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FaderRange.parse_obj(obj)

        _obj = FaderRange.parse_obj(
            {
                "default": (
                    Fader.from_dict(obj.get("default"))
                    if obj.get("default") is not None
                    else None
                ),
                "range": (
                    [Fader.from_dict(_item) for _item in obj.get("range")]
