...
class OverlayPlayRequestFromUsb(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OverlayPlayRequestFromUsb:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OverlayPlayRequestFromUsb:
        """Create an instance of OverlayPlayRequestFromUsb from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OverlayPlayRequestFromUsb.parse_obj(obj)

        _obj = OverlayPlayRequestFromUsb.parse_obj(
            {
                "from_usb": (
