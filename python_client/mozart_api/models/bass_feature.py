...
class BassFeature(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BassFeature:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BassFeature:
        """Create an instance of BassFeature from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BassFeature.parse_obj(obj)

        _obj = BassFeature.parse_obj(
            {
                "value": obj.get("value"),
                "default": (
                    Bass.from_dict(obj.get("default"))
                    if obj.get("default") is not None
                    else None
                ),
                "range": (
                    [Bass.from_dict(_item) for _item in obj.get("range")]
