...
class BassManagementRange(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BassManagementRange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BassManagementRange:
        """Create an instance of BassManagementRange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BassManagementRange.parse_obj(obj)

        _obj = BassManagementRange.parse_obj(
            {
                "default": (
