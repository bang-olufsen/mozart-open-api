...
class RemoteMenuItem(BaseModel):
    ...
    first_child_menu_item_id: Annotated[
        Optional[UUID],
        Field(
            description="ID of the first child menu item", alias="firstChildMenuItemId"
        ),
    ] = None
    label: Annotated[
        Optional[StrictStr],
        Field(description="Alternative label, if omitted mozart will try its best"),
    ] = None
    next_sibling_menu_item_id: Annotated[
        Optional[UUID],
        Field(
    ...
    parent_menu_item_id: Annotated[
        Optional[UUID],
        Field(description="ID of the parent menu item", alias="parentMenuItemId"),
    ] = None
    ...
    id: Annotated[UUID, Field(description="Unique ID for this menu item")]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": ContentItem.from_dict(obj["content"])
