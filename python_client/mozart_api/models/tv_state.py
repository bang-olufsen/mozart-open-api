...
class TvState(BaseModel):
    ...
    sound_settings: Annotated[
        Optional[TvSoundSettings], Field(alias="soundSettings")
    ] = None
    tv_info: Annotated[Optional[TvProperties], Field(alias="tvInfo")] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integration": TvIntegrationTypes.from_dict(obj["integration"])
            if obj.get("integration") is not None
            else None,
            "soundSettings": TvSoundSettings.from_dict(obj["soundSettings"])
            if obj.get("soundSettings") is not None
            else None,
            "tvInfo": TvProperties.from_dict(obj["tvInfo"])
