...
class SpatialSurroundRange(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpatialSurroundRange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpatialSurroundRange:
        """Create an instance of SpatialSurroundRange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpatialSurroundRange.parse_obj(obj)

        _obj = SpatialSurroundRange.parse_obj(
            {
                "default": (
