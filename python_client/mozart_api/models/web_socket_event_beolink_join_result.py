...
class WebSocketEventBeolinkJoinResult(BaseModel):
    ...
    event_data: Annotated[BeolinkJoinResult, Field(alias="eventData")]
    event_type: Annotated[StrictStr, Field(alias="eventType")]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "eventData": BeolinkJoinResult.from_dict(obj["eventData"])
