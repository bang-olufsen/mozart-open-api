...
class SourceTypeEnum(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SourceTypeEnum:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SourceTypeEnum:
        """Create an instance of SourceTypeEnum from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SourceTypeEnum.parse_obj(obj)

        _obj = SourceTypeEnum.parse_obj({"value": obj.get("value")})
        return _obj
