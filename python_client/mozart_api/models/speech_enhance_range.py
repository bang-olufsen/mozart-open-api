...
class SpeechEnhanceRange(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpeechEnhanceRange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpeechEnhanceRange:
        """Create an instance of SpeechEnhanceRange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpeechEnhanceRange.parse_obj(obj)

        _obj = SpeechEnhanceRange.parse_obj(
            {
                "default": (
