...
class PowerLinkTrigger(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PowerLinkTrigger:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PowerLinkTrigger:
        """Create an instance of PowerLinkTrigger from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PowerLinkTrigger.parse_obj(obj)

        _obj = PowerLinkTrigger.parse_obj(
