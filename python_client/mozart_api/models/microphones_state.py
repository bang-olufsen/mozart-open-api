...
class MicrophonesState(BaseModel):
    ...
    microphone_state: Annotated[
        Optional[MicrophoneState], Field(alias="microphoneState")
    ] = None
    microphone_switch_state: Annotated[
        Optional[MicrophoneState], Field(alias="microphoneSwitchState")
    ] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "microphoneState": MicrophoneState.from_dict(obj["microphoneState"])
            if obj.get("microphoneState") is not None
            else None,
            "microphoneSwitchState": MicrophoneState.from_dict(
                obj["microphoneSwitchState"]
            )
