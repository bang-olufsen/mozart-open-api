...
class WebSocketEventAlarmTriggered(BaseModel):
    ...
    event_data: Optional[AlarmTriggeredInfo] = Field(None, alias="eventData")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebSocketEventAlarmTriggered:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebSocketEventAlarmTriggered:
        """Create an instance of WebSocketEventAlarmTriggered from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebSocketEventAlarmTriggered.parse_obj(obj)

        _obj = WebSocketEventAlarmTriggered.parse_obj(
            {
                "event_data": AlarmTriggeredInfo.from_dict(obj.get("eventData"))
