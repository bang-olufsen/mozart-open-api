...
class WebSocketEventRoomCompensationCurrentMeasurementEvent(BaseModel):
    """
    Sent when a room compensation measurement is started/done. Is only sent when room compensation type is advanced.   # noqa: E501
    """
    ...
    def from_dict(
        ...
        _obj = WebSocketEventRoomCompensationCurrentMeasurementEvent.parse_obj(
            {
                "event_data": (
                    RoomCompensationCurrentMeasurement.from_dict(obj.get("eventData"))
