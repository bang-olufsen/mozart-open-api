...
class SpatialHeightFeature(BaseModel):
    ...
    value: Annotated[
        ...
        Field(description="Selected spatial-height value"),
    ]
    default: SpatialHeight
    range: Annotated[List[SpatialHeight], Field(description="spatial-height range")]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": obj.get("value"),
            "default": SpatialHeight.from_dict(obj["default"])
            if obj.get("default") is not None
            else None,
            "range": [SpatialHeight.from_dict(_item) for _item in obj["range"]]
