...
class SoundSettings(BaseModel):
    ...
    room_compensation: Annotated[
        Optional[RoomCompensationInfo], Field(alias="roomCompensation")
    ] = None
    tone_touch: Annotated[Optional[SoundToneTouch], Field(alias="toneTouch")] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "adjustments": SoundAdjustments.from_dict(obj["adjustments"])
            if obj.get("adjustments") is not None
            else None,
            "roomCompensation": RoomCompensationInfo.from_dict(obj["roomCompensation"])
            if obj.get("roomCompensation") is not None
            else None,
            "toneTouch": SoundToneTouch.from_dict(obj["toneTouch"])
