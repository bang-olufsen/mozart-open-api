...
class BalanceFeature(BaseModel):
    ...
    value: Annotated[
        Union[StrictFloat, StrictInt], Field(description="Selected balance value")
    ]
    default: Balance
    range: Annotated[List[Balance], Field(description="balance range")]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": obj.get("value"),
            "default": Balance.from_dict(obj["default"])
            if obj.get("default") is not None
            else None,
            "range": [Balance.from_dict(_item) for _item in obj["range"]]
