...
class WebSocketEventBeoRemoteButton(BaseModel):
    ...
    event_data: Optional[BeoRemoteButton] = Field(None, alias="eventData")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebSocketEventBeoRemoteButton:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebSocketEventBeoRemoteButton:
        """Create an instance of WebSocketEventBeoRemoteButton from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebSocketEventBeoRemoteButton.parse_obj(obj)

        _obj = WebSocketEventBeoRemoteButton.parse_obj(
            {
                "event_data": BeoRemoteButton.from_dict(obj.get("eventData"))
