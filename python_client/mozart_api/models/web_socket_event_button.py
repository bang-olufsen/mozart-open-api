...
class WebSocketEventButton(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebSocketEventButton:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebSocketEventButton:
        """Create an instance of WebSocketEventButton from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebSocketEventButton.parse_obj(obj)

        _obj = WebSocketEventButton.parse_obj(
            {
                "event_data": ButtonEvent.from_dict(obj.get("eventData"))
