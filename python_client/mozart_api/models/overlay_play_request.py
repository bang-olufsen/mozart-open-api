...
class OverlayPlayRequest(BaseModel):
    ...
    text_to_speech: Annotated[
        Optional[OverlayPlayRequestTextToSpeechTextToSpeech],
        Field(alias="textToSpeech"),
    ] = None
    from_usb: Annotated[
        Optional[OverlayPlayRequestFromUsbFromUsb], Field(alias="fromUsb")
    ] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "uri": Uri.from_dict(obj["uri"]) if obj.get("uri") is not None else None,
            "textToSpeech": OverlayPlayRequestTextToSpeechTextToSpeech.from_dict(
                obj["textToSpeech"]
            )
            if obj.get("textToSpeech") is not None
            else None,
            "fromUsb": OverlayPlayRequestFromUsbFromUsb.from_dict(obj["fromUsb"])
