...
class HdmiVideoFormat(BaseModel):
    ...
    pixel_format: Annotated[Optional[VideoPixelFormat], Field(alias="pixelFormat")] = (
        None
    )
    v_ic: Annotated[
        Optional[Annotated[int, Field(strict=True, ge=0)]], Field(alias="vIC")
    ] = None
    video_timings: Annotated[Optional[VideoTimings], Field(alias="videoTimings")] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pixelFormat": VideoPixelFormat.from_dict(obj["pixelFormat"])
            if obj.get("pixelFormat") is not None
            else None,
            "vIC": obj.get("vIC"),
            "videoTimings": VideoTimings.from_dict(obj["videoTimings"])
