...
class SpatialProcessingRange(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpatialProcessingRange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpatialProcessingRange:
        """Create an instance of SpatialProcessingRange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpatialProcessingRange.parse_obj(obj)

        _obj = SpatialProcessingRange.parse_obj(
            {
                "default": (
                    SpatialProcessing.from_dict(obj.get("default"))
