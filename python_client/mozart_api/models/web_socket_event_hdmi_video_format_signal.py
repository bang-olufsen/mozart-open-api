...
class WebSocketEventHdmiVideoFormatSignal(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebSocketEventHdmiVideoFormatSignal:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebSocketEventHdmiVideoFormatSignal:
        """Create an instance of WebSocketEventHdmiVideoFormatSignal from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebSocketEventHdmiVideoFormatSignal.parse_obj(obj)

        _obj = WebSocketEventHdmiVideoFormatSignal.parse_obj(
            {
                "event_data": HdmiVideoFormat.from_dict(obj.get("eventData"))
