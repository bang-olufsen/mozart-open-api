...
class RoomCompensationFeature(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RoomCompensationFeature:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RoomCompensationFeature:
        """Create an instance of RoomCompensationFeature from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RoomCompensationFeature.parse_obj(obj)

        _obj = RoomCompensationFeature.parse_obj(
            {
                "value": obj.get("value"),
