...
class RoomCompensationState(BaseModel):
    ...
    error_details: Annotated[
        Optional[RoomCompensationErrorDetails], Field(alias="errorDetails")
    ] = None
    last_run_available: Annotated[
        Optional[StrictBool],
        Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "state": obj.get("state"),
            "error": obj.get("error"),
            "errorDetails": RoomCompensationErrorDetails.from_dict(obj["errorDetails"])
            if obj.get("errorDetails") is not None
            else None,
            "lastRunAvailable": obj.get("lastRunAvailable"),
            "properties": RoomCompensationProperties.from_dict(obj["properties"])
