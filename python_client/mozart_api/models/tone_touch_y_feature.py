...
class ToneTouchYFeature(BaseModel):
    ...
    range: Annotated[
        List[ToneTouchType],
        Field(description="Product and role specific tone touch X or Y range"),
    ]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": obj.get("value"),
            "default": ToneTouchType.from_dict(obj["default"])
            if obj.get("default") is not None
            else None,
            "range": [ToneTouchType.from_dict(_item) for _item in obj["range"]]
