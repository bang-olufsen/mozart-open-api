...
class SpatialProcessingFeature(BaseModel):
    ...
    value: Annotated[StrictStr, Field(description="Selected spatial-processing value")]
    default: SpatialProcessing
    range: Annotated[
        List[SpatialProcessing], Field(description="spatial-processing range")
    ]
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["direct", "trueimage", "downmix", "dolbymode"]):
            raise ValueError(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": obj.get("value"),
            "default": SpatialProcessing.from_dict(obj["default"])
            if obj.get("default") is not None
            else None,
            "range": [SpatialProcessing.from_dict(_item) for _item in obj["range"]]
