...
class WebSocketEventSoftwareUpdateState(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebSocketEventSoftwareUpdateState:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebSocketEventSoftwareUpdateState:
        """Create an instance of WebSocketEventSoftwareUpdateState from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebSocketEventSoftwareUpdateState.parse_obj(obj)

        _obj = WebSocketEventSoftwareUpdateState.parse_obj(
            {
                "event_data": SoftwareUpdateState.from_dict(obj.get("eventData"))
