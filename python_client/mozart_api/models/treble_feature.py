...
class TrebleFeature(BaseModel):
    ...
    value: Annotated[StrictInt, Field(description="Selected treble value")]
    default: Treble
    range: Annotated[
        List[Treble], Field(description="Product and role specific treble range")
    ]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": obj.get("value"),
            "default": Treble.from_dict(obj["default"])
            if obj.get("default") is not None
            else None,
            "range": [Treble.from_dict(_item) for _item in obj["range"]]
