...
class WebSocketEventPlaybackMetadata(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebSocketEventPlaybackMetadata:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebSocketEventPlaybackMetadata:
        """Create an instance of WebSocketEventPlaybackMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebSocketEventPlaybackMetadata.parse_obj(obj)

        _obj = WebSocketEventPlaybackMetadata.parse_obj(
            {
                "event_data": PlaybackContentMetadata.from_dict(obj.get("eventData"))
