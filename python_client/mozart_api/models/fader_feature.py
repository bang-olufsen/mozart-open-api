...
class FaderFeature(BaseModel):
    ...
    value: Annotated[
        Union[StrictFloat, StrictInt], Field(description="Selected fader value")
    ]
    default: Fader
    range: Annotated[List[Fader], Field(description="fader range")]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": obj.get("value"),
            "default": Fader.from_dict(obj["default"])
            if obj.get("default") is not None
            else None,
            "range": [Fader.from_dict(_item) for _item in obj["range"]]
