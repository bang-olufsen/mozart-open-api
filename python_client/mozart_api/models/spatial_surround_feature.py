...
class SpatialSurroundFeature(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpatialSurroundFeature:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpatialSurroundFeature:
        """Create an instance of SpatialSurroundFeature from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpatialSurroundFeature.parse_obj(obj)

        _obj = SpatialSurroundFeature.parse_obj(
            {
                "value": obj.get("value"),
                "default": (
                    SpatialSurround.from_dict(obj.get("default"))
