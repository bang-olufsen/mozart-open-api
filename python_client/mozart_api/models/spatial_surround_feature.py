...
class SpatialSurroundFeature(BaseModel):
    ...
    value: Annotated[
        ...
        Field(description="Selected spatial-surround value"),
    ]
    default: SpatialSurround
    range: Annotated[List[SpatialSurround], Field(description="spatial-surround range")]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": obj.get("value"),
            "default": SpatialSurround.from_dict(obj["default"])
            if obj.get("default") is not None
            else None,
            "range": [SpatialSurround.from_dict(_item) for _item in obj["range"]]
