...
class SpatialWidthFeature(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpatialWidthFeature:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpatialWidthFeature:
        """Create an instance of SpatialWidthFeature from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpatialWidthFeature.parse_obj(obj)

        _obj = SpatialWidthFeature.parse_obj(
            {
                "value": obj.get("value"),
                "default": (
