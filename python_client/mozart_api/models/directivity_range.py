...
class DirectivityRange(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectivityRange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DirectivityRange:
        """Create an instance of DirectivityRange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectivityRange.parse_obj(obj)

        _obj = DirectivityRange.parse_obj(
            {
                "default": (
