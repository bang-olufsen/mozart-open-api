...
class BeolinkExperience(BaseModel):
    ...
    category: Annotated[StrictStr, Field(description="Source category")]
    id: Annotated[
        StrictStr, Field(description='experience id, e.g. "RADIO" or "toslink"')
    ]
    linkable: Annotated[
        StrictBool,
        Field(
    ...
    name: Annotated[
        StrictStr, Field(description='Experience name, e.g. "Bluetooth" or "B&O Radio"')
    ]
    product_friendly_name: Annotated[
        Optional[StrictStr],
        Field(
            description="Optional product friendly name", alias="productFriendlyName"
        ),
    ] = None
    source_friendly_name: Annotated[
        Optional[StrictStr],
        Field(
            description="Optional friendly name for source", alias="sourceFriendlyName"
        ),
    ] = None
    type: Annotated[
        StrictStr,
