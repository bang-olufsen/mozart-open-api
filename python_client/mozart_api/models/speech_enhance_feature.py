...
class SpeechEnhanceFeature(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpeechEnhanceFeature:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpeechEnhanceFeature:
        """Create an instance of SpeechEnhanceFeature from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpeechEnhanceFeature.parse_obj(obj)

        _obj = SpeechEnhanceFeature.parse_obj(
            {
                "value": obj.get("value"),
                "default": (
                    SpeechEnhance.from_dict(obj.get("default"))
                    if obj.get("default") is not None
                    else None
                ),
                "range": (
                    [SpeechEnhance.from_dict(_item) for _item in obj.get("range")]
