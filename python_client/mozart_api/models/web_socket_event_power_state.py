...
class WebSocketEventPowerState(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebSocketEventPowerState:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebSocketEventPowerState:
        """Create an instance of WebSocketEventPowerState from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebSocketEventPowerState.parse_obj(obj)

        _obj = WebSocketEventPowerState.parse_obj(
            {
                "event_data": PowerStateEnum.from_dict(obj.get("eventData"))
